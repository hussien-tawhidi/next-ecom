    ...
    <div className="p-4 max-w-3xl mx-auto">
      ...
      >
        ...
        <Input
          ...
          onChange={({ target }) => setProductInfo({ ...productInfo, title: target.value })} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} crossOrigin={undefined}        />

        <Textarea
          className="h-52"
          label="Description"
          value={productInfo.description}
          onChange={({ target }) => setProductInfo({ ...productInfo, description: target.value })} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}        />
        ...
        <Select
          ...
          label="Select Category"placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}        >
          {categories.map((c) => (
        ...
        <div className="flex space-x-4">
          <div className="space-y-4 flex-1">
            ...
            <Input
              ...
              className="mb-4" onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} crossOrigin={undefined}            />
            <Input
        ...
        <Button disabled={isPending} type="submit" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
          {getBtnTitle()}
        </Button>
      </form>
    </div>
