...
import { createFeaturedProduct, updateFeaturedProduct } from "@/app/(admin)/products/featured/action";
...
export default function FeaturedProductForm({ initialValue }: Props) {
  ...
  return (
    ...
    >
      ...
      <Input label="Title" name="title" value={title} onChange={handleChange} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} crossOrigin={undefined} />
      <div className="flex space-x-4">
        <Input label="Link" name="link" value={link} onChange={handleChange} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} crossOrigin={undefined} />
        <Input
          label="Lik Title"
          name="linkTitle"
          value={linkTitle}
