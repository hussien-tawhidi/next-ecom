...
export default function ProductTable(props: Props) {
  ...
  return (
    <div className="py-5">
                  ...
                  <td className={classes}>
                    <div className="flex items-center gap-3">
                      <Avatar
                        ...
                        alt={title}
                        size="md"
                        variant="rounded" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}                      />
                      <Link href={`/${title}/${id}`}>
                        <Typography
                          variant="small"
                          color="blue-gray"
      ...
      {showPageNavigator ? (
        <CardFooter className="flex items-center justify-center border-t border-blue-gray-50 p-4" placeholder={undefined} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
